    ...
    <div className="w-full max-w-[380px]">
      <div className="bg-[rgb(var(--surface))] border border-[rgb(var(--border))] rounded-2xl p-8">
        ...
        <div className="mb-7 text-center">
          ...
          <p className="text-sm text-[rgb(var(--text-muted))] mt-1.5">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-[rgb(var(--surface))] px-3 text-[11px] text-[rgb(var(--text-muted))] uppercase tracking-widest">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div className="rounded-lg border border-[rgb(var(--danger)/0.3)] bg-[rgb(var(--danger)/0.08)] px-3 py-2 text-sm text-[rgb(var(--danger))]">
              {error}
            </div>
          )}
